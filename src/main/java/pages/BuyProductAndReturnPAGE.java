...
public class BuyProductAndReturnPAGE extends BasePage{
    public BuyProductAndReturnPAGE(WebDriver driver){
        super(driver);
    ...
    private WebElement myAccountButton3;
    public void clickOnMyAccountButton3(){myAccountButton3.click();}
    @FindBy(css = "#widget-navbar-217834 > ul > li:nth-child(6) > ul > li:nth-child(6) > a > div > span")
